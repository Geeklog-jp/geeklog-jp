...
$LANG_GF01['FORUMSUBSCRIBE'] = 'ただいまこの掲示板は非通知中です。';
$LANG_GF01['FORUMUNSUBSCRIBE'] = 'ただいまこの掲示板は通知中です';
$LANG_GF01['NEWTOPIC']       = '新規投稿';
$LANG_GF01['SubscribeLink']  = 'ただいまこのトピックは非通知中です。';
$LANG_GF01['unSubscribeLink'] = 'ただいまこのトピックは通知中です。';
$LANG_GF01['POSTREPLY']      = 'レス投稿';
...
$LANG_GF02['msg142']   = 'メール通知モードに変更しました。';
$LANG_GF02['msg143']   = '通知';
$LANG_GF02['msg144']   = 'トピックへ';
$LANG_GF02['msg145']   = 'スレッド参照';
$LANG_GF02['msg146']   = 'メール通知は解除されました。';
...
$LANG_GF93 = array (
    ...
    'deleteforumnote1'   => '<b>"%s"</b>&nbsp;削除してもよろしいですか ?',
    'editcatnote'        => '編集: <b>"%s"</b>',
    'deletecatnote1'     => '<b>"%s"</b>&nbsp;削除してもよろしいですか ?',
    'deletecatnote2'     => 'このカテゴリーのすべての掲示板とトピックも削除されます。',
    'undercat'           => 'カテゴリー:',
    'deleteforumnote2'   => 'その直下の投稿はすべて削除されます。',
    'groupaccess'        => 'グループ: ',
