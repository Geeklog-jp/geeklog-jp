...
// +---------------------------------------------------------------------------+
// | public_html/admin/plugins/tkgmaps/install.php                             |
// +---------------------------------------------------------------------------+
...
$GROUPS = array();
$GROUPS[$pi_admin] = 'Users in this group can administer the tkgmaps plugin';
$FEATURES = array();
$FEATURES['tkgmaps.admin'] = $pi_admin;
$MAPPINGS = array();
...
{
    if (!function_exists ('SEC_createToken')) { return false; }
    return true;
}
