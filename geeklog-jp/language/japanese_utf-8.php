...
$LANG04 = array(
    ...
    61 => '順番',
    62 => '初期値は100です',
    63 => "パスワードをメールで送信しました。メールを参照してログインしてください。",
    64 => 'コメントの設定:',
    65 => 'ログインしてください',
    66 => 'ログインしてください',
    67 => '登録日時',
...
$LANG_DB_BACKUP = array(
    ...
    'db_explanation' => 'Geeklogのバックアップは、新規作成をクリックしてください。',
...
$LANG_SECTEST = array(
    ...
    'not_sure' => 'HTTPコード%sを取得(テスト:%s)。それで何を作るべきかは確かでありません...',
