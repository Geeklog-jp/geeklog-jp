...
$LANG24 = array(
    ...
    49 => '右',
    50 => '左',
    51 => '<p>添付した画像は、自動タグで記述してください。書式は、[imageX]、[imageX_right]、[imageX_left]（Xは添付した画像の番号）（例 [image1]）。注意: 添付した画像は記事内ですべて使用しなければ記事を保存できません。</p><br' . XHTML . '><p><strong>プレビュー</strong>: 画像付きの記事はドラフト（下書き）として保存して閲覧してください。プレビューボタンは画像が無いときにのみ利用できます。</p>',
    52 => '',
...
$LANG_SECTEST = array(
    ...
    'fix_password'  => 'あなたはまだ %s の Rootユーザアカウントの<strong>デフォルトパスワード</strong>を"password"から変更していません。',
    'password_okay' => 'Good! あなたは既にデフォルトアカウントのパスワードを変更しています。'
);
...
$LANG_confignames['Core'] = array(
    ...
    'clickable_links' => 'クリッカブルURLを作成する',
    'compressed_output' => '出力を圧縮して送信する',
    'frame_options' => '"clickjacking"を防御する',
    'censormode' => 'チェックする',
