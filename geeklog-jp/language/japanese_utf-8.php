...
$LANG04 = array(
    ...
    133 => 'コメント表示',
    134 => 'コメントオプション',
    135 => '<li>デフォルトの表示モードを設定してください。</li><li>コメントを表示するデフォルトのソート順を設定してください。</li><li>表示するコメントの最大数を設定してください。デフォルトは100件です。</li>',
    136 => '話題と投稿者の除外',
    137 => '記事のフィルタリング',
    138 => 'その他の設定',
    139 => 'レイアウトと言語',
...
$LANG_confignames['Core'] = array(
    ...
    'article_comment_close_enabled' => '自動的にコメントの受付を停止する(初期値)',
    'article_comment_close_days' => '停止までの日数(初期値)',
...
$LANG_fs['Core'] = array(
    ...
    'fs_iplookup' => 'IP検索',
    'fs_perm_story' => '記事のパーミッションの初期設定（[0]所有者 [1]グループ [2]メンバー [3]ゲスト）',
    'fs_perm_topic' => '話題のパーミッションの初期設定（[0]所有者 [1]グループ [2]メンバー [3]ゲスト）',
    'fs_perm_block' => 'ブロックのパーミッションの初期設定（[0]所有者 [1]グループ [2]メンバー [3]ゲスト）',
