...
$LANG04 = array(
    ...
    133 => 'コメント表示',
    134 => 'コメントオプション',
    135 => '<li>既定のコメント表示法</li><li>コメントを表示する既定の順序</li><li>表示するコメントの最大数を設定してください。初期値は100件です。</li>',
    136 => '話題と投稿者の除外',
    137 => '記事のフィルタリング',
    138 => 'その他の設定',
    139 => 'レイアウトと言語',
    ...
    141 => 'プライバシーの設定',
    142 => '初期設定では、他のユーザや管理者があなたにメールアドレスを送ることができ、オンラインかどうかを表示するようになっています。プライバシーを保護するには、対応するオプションのチェックを外してください。',
    143 => 'ブロックのフィルタリング',
    144 => 'ブロックの表示・非表示',
    145 => '公開プロフィール',
    146 => 'パスワードとメールアドレス',
...
$LANG27 = array(
    ...
    7 => '話題IDと話題名を入力してください',
    8 => '話題管理',
    9 => '話題とは、記事カテゴリのことです。話題の編集・削除は各話題名を、新しい話題の作成は「新規作成」リンクをクリックしてください。カッコ内はあなたのアクセスレベルです。アスタリスク(*)付きの話題は、記事投稿時の既定の話題です。',
    10 => '並べる順序',
    11 => '1ページあたりの記事数',
    12 => 'アクセスが拒否されました',
...
$MESSAGE = array(
    ...
    76 => 'この項目を削除してもよいですか?',
    77 => '警告:<br' . XHTML . '>エンコーディングの既定値をUTF-8に設定していますが、サーバがマルチバイトエンコーディングをサポートしていません。PHP用に mbstring モジュールをインストールするか、UTF-8ではないキャラクタセットないし言語に変更してください。',
...
$LANG_SECTEST = array(
    ...
    'fix_password'  => 'あなたはまだ %s の Rootユーザアカウントの<strong>パスワード</strong>を初期値の"password"から変更していません。',
    'password_okay' => 'Good! Rootユーザアカウントのパスワードを初期値から変更しています。'
);
...
$LANG_confignames['Core'] = array(
    ...
    'num_search_results' => '検索結果表示件数の初期値',
    ...
    'emailstoriesperdefault' => '新規ユーザの初期値',
    ...
    'url_rewrite' => 'URLリライト',
    'meta_tags' => 'メタタグ',
    'meta_description' => '説明文のメタタグの初期値',
    'meta_keywords' => 'キーワードのメタタグの初期値',
    ...
    'article_comment_close_enabled' => '自動的にコメントの受付を終了する(初期値)',
    'article_comment_close_days' => '終了までの日数(初期値)',
    'comment_close_rec_stories' => 'コメント可能な記事の最大値',
    'allow_reply_notifications' => '返信のメール通知を許可する',
    'search_style' => '検索結果表示スタイル',
    'search_limits' => '表示件数オプション',
    'search_show_num' => '検索順の番号を表示する',
    'search_show_type' => 'タイプを表示する',
    'search_show_sort' => 'ユーザーにソートを許可する',
    'search_show_limit' => '表示件数オプションを表示する',
    'search_separator' => 'タイプのセパレータ',
    'search_def_keytype' => '検索条件の初期値'
);
...
$LANG_fs['Core'] = array(
    ...
    'fs_iplookup' => 'IP検索',
    'fs_perm_story' => '記事の権限の初期値（[0]所有者 [1]グループ [2]メンバー [3]ゲスト）',
    'fs_perm_topic' => '話題の権限の初期値（[0]所有者 [1]グループ [2]メンバー [3]ゲスト）',
    'fs_perm_block' => 'ブロックの権限の初期値（[0]所有者 [1]グループ [2]メンバー [3]ゲスト）',
