...
$LANG_SX00 = array(
    ...
    'access_denied_msg' => 'Rootユーザーだけがこのページにアクセスできます。あなたのユーザー名とIPアドレスを記録しました。',
    'admin' => 'プラグイン管理',
    'install_header' => 'インストール/アンインストールプラグイン',
    'installed' => 'プラグインをインストールしてあります。',
    'uninstalled' => 'プラグインをインストールしてありません。',
    'install_success' => 'インストールしました',
    'install_failed' => 'インストールできませんでした。原因を調べるにはエラーログを参照してださい。',
    ...
    'edit_http_header_blacklist' => 'HTTPヘッダーのブラックリストを編集',
    'edit_ip_blacklist' => 'IPアドレスのブラックリストを編集',
