...
$LANG_SX00 = array(
    ...
    'allow_url_fopen' => '<p>あなたのWebサーバのコンフィギュレーションはリモートファイルの読み込みを許可していません。 (<code>allow_url_fopen</code> がオフ)。次のURLからブラックリストをダウンロードしてGeeklogの "data" ディレクトリにアップロードしてください。<tt>%s</tt>, 再実行の前に:',
    ...
    'edit_http_header_blacklist' => 'HTTPヘッダーブラックリストを編集',
