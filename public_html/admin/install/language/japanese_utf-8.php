...
$LANG_INSTALL = array(
    ...
    3 => 'Geeklogをインストールする',
    4 => 'PHP 4.3.0以上が必要です',
    5 => '残念ながらGeeklogをインストールするには最低でもPHP 4.3.0が必要です(現在のバージョンは ',
    6 => ')。自分で<a href="http://www.php.net/downloads.php">PHPをバージョンアップする</a>か、ホスティング会社に依頼してください。',
    7 => 'Geeklogファイルが見つかりません',
    8 => 'Geeklogの重要なファイルが見つかりません。デフォルトの位置から移動させていると思われます。下のテキストボックスにファイルのパスを入力してください。:',
    ...
    52 => '残念ながらGeeklogをインストールするには最低でもMySQL 3.23.2が必要です(現在のバージョンは ',
...
$LANG_MIGRATE = array(
    ...
    6 => 'バックアップファイルを選択',
    7 => 'ファイル選択...',
    8 => 'サーバのbackupsディレクトリから',
    9 => 'あなたのコンピュータから',
    10 => 'ファイル選択...',
    11 => 'バックアップファイルが見つかりませんでした。',
    12 => 'このサーバのアップロード制限は',
    13 => 'です。バックアップファイルがこれより大きい場合は制限値の',
    14 => 'を変更してください。タイムアウトになる場合は、FTPでバックアップファイルをサーバにアップロードしてください。',
    ...
    20 => ' へ ',
    21 => 'ファイル',
    22 => 'がすでにサーバにあります。指定したファイルに置き換えますか?',
    23 => 'はい',
    24 => 'いいえ',
...
$LANG_ERROR = array(
    ...
    7 => 'アップロードするファイルはphp.iniで指定されたpost_max_sizeを超えています。データベースを、たとえばFTPなどでアップロードしてください。',
    8 => 'エラー',
    9 => 'データベース接続エラー:',
