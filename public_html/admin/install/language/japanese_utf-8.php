...
$LANG_INSTALL = array(
    ...
    106 => 'PostgreSQL',
    107 => 'Database Password is required for production environments.(翻訳候補:データベースのパスワードが必要です。)',
    108 => 'No Database Drivers found!(翻訳候補:データベースドライバーがありません!)'
);
