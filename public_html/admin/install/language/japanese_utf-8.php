...
$LANG_INSTALL = array(
    ...
    3 => 'Geeklogをインストールする',
    4 => 'PHP %s以上が必要です',
    5 => 'Geeklogをインストールするには最低でもPHP %sが必要です(現在のバージョンは ',
    ...
    20 => '警告!',
    21 => '以下のエラーを解消するまで、インストールできません。先に必要な変更を行ってください。',
    22 => '不明',
    ...
    52 => 'Geeklogをインストールするには最低でもMySQL %sが必要です(現在のバージョンは ',
    53 => ')。自分で<a href="http://dev.mysql.com/downloads/mysql/">MySQLをアップグレードする</a>か、ホスティング会社に依頼してください。',
    54 => 'データベース情報が不正確です',
    55 => '入力したデータベース情報が不正確です。戻ってやり直してください。',
    56 => 'データベースに接続できません',
    57 => '指定しているデータベースが見つかりません。データベースが存在しないか、綴り(大文字小文字)が違うのでしょう。戻ってやり直してください。',
    58 => '。このファイルはWebサーバーから書き込みできますか?',
    59 => '注意:',
    60 => 'お使いのMySQLのバージョンではInnoDBテーブルをサポートしていません。InnoDBサポートなしで、インストールを続けますか?',
    61 => '戻る',
    62 => '次へ',
    ...
    68 => 'データベースが空ではありません。データベース中のテーブルをすべて削除してから、やり直してください。',
    69 => 'Geeklogをアップグレード',
    ...
    71 => '現在のGeeklogのバージョンを下で正確に選択してください。インストール・スクリプトは入力したバージョンから少しずつアップグレードしていきます(つまり、任意の古いバージョンから次のバージョンへアップグレードできます:',
    72 => ')。',
    ...
    77 => 'インストーラーは現在のGeeklogのバージョンを判定できませんでした。下のリストから選択してください:',
    78 => 'アップグレードエラー',
    79 => 'Geeklogのアップグレード中にエラーが発生しました。',
    80 => '変更',
    81 => 'ちょっと待って!',
    82 => '下に列挙したファイルのパーミッションを必ず変更する必要があります。変更するまでGeeklogをインストールできません。',
    83 => 'インストールエラー',
    84 => 'パス "',
    ...
    89 => '現在のバージョン:',
    90 => 'データベースは空?',
    91 => 'データベースが空のままか、入力してデータベースの情報が不正確なようです。もしかするとアップグレードではなく、新規インストールするつもりだったのではないでしょうか?  戻ってやり直してください。',
    92 => 'UTF-8を使用する',
    93 => '成功',
    94 => 'パスのヒント:',
    95 => 'インストールスクリプトファイルへの完全なパスはこちらです:',
    96 => 'インストーラーはここで %s を探しています:',
    97 => 'パーミッション設定',
    98 => 'アドバンストユーザー',
    99 => 'コマンドライン (SSH) が使えるなら、Webサーバーにアクセスしてください。shellを使えば、以下のコマンドのコピー・ペーストで簡単に実行できます。:',
    100 => '無効なモードを指定',
    101 => 'ステップ',
...
$LANG_SUCCESS = array(
    ...
    19 => '<strong>注意:</strong> セキュリティモデルを変更したので、新しいサイトの管理権限を持ったアカウントを作成しました。ユーザー名は <strong>NewAdmin</strong> で、パスワードは <strong>password</strong> です。',
    20 => 'インストール',
    21 => 'アップグレード',
    22 => '移行'
);
...
$LANG_MIGRATE = array(
    0 => 'バックアップファイルに"DROP TABLE"を追加している場合、同じ名前のテーブルを上書きします。',
    1 => '実行する前に',
    2 => '以前のプラグインを新しいサーバーにコピーしていることを確認してください。',
    3 => '画像ディレクトリ<code>public_html/images/articles/</code>、<code>public_html/images/topics/</code>および<code>public_html/images/userphotos/</code>を、新しいサーバーに移行していることを確認してください。',
...
$LANG_BIGDUMP = array(
    ...
    18 => 'クエリ:',
    19 => 'MySQL:',
    20 => 'ファイルポインターのオフセットを読み込めません。',
    21 => 'gzip形式で圧縮したファイルでは利用できません',
    22 => '進捗状況',
...
$LANG_ERROR = array(
    0 => 'アップロードしたファイルは、php.iniで指定した制限 upload_max_filesize を超えています。他の方法、たとえばFTPでアップロードしてください。',
    1 => 'アップロードしたファイルのサイズは、HTMLのフォームで指定したMAX_FILE_SIZEを超えています。バックアップファイルをFTPなどの他の方法でアップロードしてください。',
    2 => 'ファイルの一部だけしかアップロードできませんでした。',
    3 => 'アップロードしたファイルはありません。',
    4 => '一時フォルダーがありません。',
    5 => 'ディスク書き込みエラーです。',
    6 => '拡張子制限により、アップロードを中止しました。',
    7 => 'アップロードするファイルはphp.iniで指定したpost_max_sizeを超えています。データベースをFTPなどでアップロードしてください。',
    8 => 'エラー',
    9 => 'データベース接続エラー:',
...
$LANG_HELP = array(
    ...
    'db_type' => 'データベースの種類を入力します。MySQL, MySQL(InnoDB), Microsoft SQL Serverの中から選びます。</p><p class="indent"><strong>注意:</strong> 大規模なサイトではInnoDBテーブルを使用すると、パフォーマンスが改善するかもしれませんが、バックアップを行うのが難しくなります。',
    'db_host' => 'ホスト名を入力します。',
    'db_name' => 'データベース名を入力します。',
    'db_user' => 'データベースのユーザー名(アカウント)を入力します。',
    'db_pass' => 'パスワードを入力します。',
...
$LANG_RESCUE = array(
    ...
    4 => '終了したら、<strong>必ずこのファイル( {{SELF}} )とinstallディレクトリを削除してください!</strong>  他のユーザーがパスワードの推測に成功した場合、インストールしているGeeklogが重大な被害を被る可能性があります。',
     5 => '状態',
     6 => 'これからセキュリティで保護したセクションにアクセスします。セキュリティの検査に合格しなけいと先に進めません。',
     7 => '本人確認のために、データベースのパスワードを入力する必要があります。このパスワードはGeeklogの"非公開領域/db-config.php"に保存します。',
     8 => 'パスワード',
     9 => '確認する',
    10 => 'パスワードが不正です!',
    11 => '有効化 ',
    ...
    19 => 'パスワードをリクエストしました',
    20 => '誰か(あなたであれば幸いです)がGeeklog緊急レスキューツールの緊急パスワードリクエストフォームにアクセスしました。新しいパスワード "%s" (アカウント "%s" サーバー %s)を作成しました。',
    21 => 'リクエストした覚えがない場合、サイトのセキュリティを確認してください。緊急レスキューツール "/admin/install/rescue.php" を忘れずに削除してください。',
    22 => '新しいパスワードを記録しているメールアドレスに送りました。',
    ...
    33 => '主要な$_CONF変数の編集',
    34 => '管理者パスワードのリセット',
    35 => 'このサイトに現在インストールしているプラグインを有効/無効にできます。',
    36 => 'プラグインを選択してください',
    37 => '有効化',
    38 => '無効化',
    39 => 'このサイトに現在インストールしているブロックを有効/無効にできます。',
    40 => 'ブロックを選択してください',
    41 => '実行',
