...
$LANG04 = array(
    ...
    19 => 'ユーザー名かメールアドレスが既に使われています。',
    20 => 'このメールアドレスは有効なアドレスではないようです',
    21 => 'エラー',
    22 => '新規登録',
    23 => "{$_CONF['site_name']}にユーザーアカウントを登録すると、コメントや記事の投稿をあなたの名前で投稿できます。そうでなければゲストユーザーとしてしか投稿できません。なお、サイト上でメールアドレスが表示されることはありません。",
    24 => 'パスワードはここに入力されたメールアドレス宛てに送信されます。',
    25 => 'パスワード再設定',
    26 => 'ご登録頂いているユーザー名またはメールアドレスの<strong>どちらかを入力</strong>して「送信」ボタンを押してください。ご登録のメールアドレス宛にパスワード再設定用のURLを記載したメールが送信されます。',
    27 => '新規登録',
    28 => '送信',
    29 => 'ログアウトしました:',
    30 => 'ログインしました:',
    ...
    94 => 'アカウント（"%s"）を削除',
    95 => 'あなたのアカウントを削除するには、下の「アカウント削除」ボタンをクリックしてください。ただし、あなたのアカウント名で投稿された記事やコメントは<strong>削除されません</strong>。これらの記事やコメントは「ゲストユーザー」の投稿として表示されます。',
    96 => 'アカウント削除',
    97 => 'アカウント削除の確認',
    ...
    138 => 'その他の設定',
    139 => 'レイアウトと言語',
    140 => '<li>「話題別アイコンを非表示」をチェックすると、記事に話題別アイコンが表示されなくなります。</li><li>「ブロック非表示」をチェックすると、管理者メニューブロック・ユーザーメニューブロック・話題ブロックのみの表示となります。</li><li>1ページに表示する記事の最大数を設定してください。</li><li>テーマと好みの日時のフォーマットを設定してください。</li>',
    141 => 'プライバシーの設定',
    142 => 'デフォルトでは、他のユーザーや管理者があなたにメールアドレスを送ることができ、オンラインかどうかを表示するようになっています。プライバシーを保護するには、対応するオプションのチェックを外してください。',
    143 => 'ブロックのフィルタリング',
    144 => 'ブロックの表示・非表示',
    145 => '公開プロフィール',
    146 => 'パスワードとメールアドレス',
    ...
    148 => '個人情報',
    149 => '他のユーザーにも読める個人情報を編集します。<ul><li>「署名」はコメントや掲示板の投稿に付加されます。</li><li>「自己紹介」は他のユーザーにも読める短い自己紹介です。</li><li>「PGP公開鍵」を公開しましょう。</li></ul>',
    150 => '',
    156 => 'アカウント削除',
    157 => 'アカウント削除オプション',
    158 => 'タイムゾーン',
    ...
    162 => 'リサイズなし',
    163 => '再認証エラー',
    164 => '再認証回数を超えました。操作はアボートされ、今回の編集作業は失われました。',
    165 => 'アドバンストエディターを使う',
    166 => 'リモートアカウントの再同期',
    167 => 'リモートログイン',
...
$LANG21 = array(
    ...
    28 => 'PHPブロックのオプション',
    29 => '関数',
    30 => 'PHPを使用したブロックを使う場合、接頭子「phpblock_」（例 phpblock_themetester）のPHP関数名を入力してください。この接頭子が付いていない関数は呼び出されません。これは、悪意を持ったユーザーがサイトに有害な関数を定義することを避けるためです。ファンクション名の後に"()"を付けると、2つのパラメーターをコールします。ひとつめは gl_blocksテーブルの配列。ふたつめは2つの括弧の間のテキストが格納されます。この関数は、あらかじめGeeklogの/path/to/geeklog/system/lib-custom.phpに記述しておかなければなりません。すべてのPHPブロックのコードは、lib-custom.phpに記述します。そうすることにより、Geeklogをスムーズにアップグレードできます。訳注:日本語版では、フォルダー system/customを作成し、その中にカスタム関数を入れて、よりアップグレードしやすい構成にしています。',
...
$LANG24 = array(
    ...
    75 => '全機能',
    76 => '公開オプション',
    77 => 'アドバンストエディターの利用は、ブラウザーでJavaScriptが使える環境にする必要があります。このオプションはコンフィギュレーションの管理パネルで無効にできます。',
...
$LANG28 = array(
    ...
    11 => 'ユーザー管理',
    12 => 'ユーザーの編集・削除は編集アイコンをクリック、ユーザーの作成は「新規作成」をクリック、ユーザーの一括登録（インポート）は「一括登録」をクリック、ユーザーの一括削除は「一括削除」をクリックしてください。',
    13 => 'セキュリティ',
    14 => '登録日',
    15 => '',
    16 => '',
    ...
    23 => '一括登録',
    24 => 'ユーザーの一括登録',
    25 => 'ユーザーをGeeklogに一括登録できます（重複チェック付き）。一括登録するファイルはユーザーは1行あたり1人ずつで、各ユーザーのデータはタブ区切りで「氏名、ユーザー名、メールアドレス」のフィールド順です。ユーザーのパスワードは無作為に決定されます。ファイルはかならず本サイトと同じ文字コードのテキスト形式で保存してください。',
    26 => '',
    27 => '',
    28 => '画像を削除する場合チェックする',
    29 => 'パス',
    ...
    56 => '削除したいユーザーの種類を選択して「リスト更新」をクリックしてください。次に、削除したくないユーザーのチェックを外して「削除」アイコンをクリックしてください。このリストがページをまたがっている場合、現在表示されているユーザーしか削除されないので注意してください。',
    57 => '幽霊ユーザー',
    58 => '一時的ユーザー',
    59 => '過去のユーザー',
    60 => 'Users that registered more than ',
    61 => 'ヶ月以前に登録後、一度もログインしていないユーザー。',
    62 => 'Users that registered more than ',
    63 => 'ヶ月以前に登録して24時間以内にログイン後、再びログインしていないユーザー。',
    64 => 'Normal users, who simply did not visit your site since ',
    65 => 'ヶ月間、サイトを訪問していないユーザー。',
    66 => 'リストを更新',
    67 => '登録して何ヶ月経つか',
    68 => 'オンライン時間',
    69 => 'オフライン月数',
    70 => '削除できませんでした',
    71 => '削除されました',
    72 => '削除するユーザーが選択されていません',
    73 => '削除すると元に戻せません。選択したユーザーをすべて削除してよいですか?',
    74 => '直近のユーザー',
    75 => '直近',
    76 => 'ヶ月に登録したユーザー。',
    77 => '選択したユーザーにログインのリマインダーをメールで送信',
    78 => 'リマインダーを送信',
    79 => 'リマインダーを送信するユーザーが選択されていません',
    80 => 'リマインダーの送信に成功しました',
    ...
    'autotag_desc_user' => '[user: id alternate title] - ユーザー名でユーザーへのリンクを表示。アンカーテキストの指定は任意。'
);
...
$LANG_ACCESS = array(
    ...
    'permmsg' => '参考: メンバーとはログインしているメンバー。ゲストユーザーとは、ログインせずに閲覧している一般の閲覧者。',
    'securitygroups' => 'セキュリティグループ',
    'editrootmsg' => "管理権限を持っていても、RootユーザーにならずにRootユーザーを編集することはできません。それ以外のユーザーの編集は可能です。権限なしにRootユーザーを編集しようとした場合、記録に残ることに注意してください。<a href=\"{$_CONF['site_admin_url']}/user.php\">ユーザー管理ページ</a>に戻る",
    ...
    'editgroupmsg' => 'グループメンバーの編集は、メンバー名をクリックして「追加」または「削除」ボタンをクリックしてください。ユーザーがグループメンバーのときは右側だけに表示されます。編集が終わったら、「保存」ボタンをクリックしてください。管理画面に戻ります。',
...
$LANG_DB_BACKUP = array(
    ...
    'download' => 'ファイルダウンロード',
    'new_backup' => '新規バックアップ',
    'delete_failure' => '1つ以上のバックアップファイルを削除できませんでした。',
    ...
    'conversion_patience' => '注意: 変換にはある程度の時間を要します。お待ちください。',
...
$LANG_SECTEST = array(
    ...
    'remove_inst2' => 'そのままにしておくと、悪意のあるユーザーがあなたがインストールしたものを破壊したり、サイトを乗っ取ったり、重要な情報を読み出したりするおそれがあります。',
...
$LANG_confignames['Core'] = array(
    ...
    'path_themes' => 'テーマパス',
    'disable_new_user_registration' => '新規ユーザー登録を拒否する',
    ...
    'whosonline_anonymous' => 'ゲストユーザーには表示しない',
    'whosonline_photo' => '写真を表示する',
    'emailstories' => 'デイリーダイジェストを送信する',
    'emailstorieslength' => '記事の長さ',
    'emailstoriesperdefault' => 'ユーザー登録で有効をデフォルトにする',
    ...
    'onlyrootfeatures' => 'Rootユーザーのみ注目記事を設定できる',
    ...
    'allow_user_scaling' => 'ユーザーに画像サイズ変更を許可',
    ...
    'passwordspeedlimit' => 'パスワード要求間隔制限',
    ...
    'user_html' => 'ユーザーHTML',
    'admin_html' => '管理者HTML',
    'advanced_html' => 'アドバンストエディター用追加HTML',
    'skip_html_filter_for_root' => 'RootユーザーはHTMLフィルター無効',
    ...
    'article_comment_close_enabled' => '自動的コメント受付終了をデフォルトにする',
    'article_comment_close_days' => '停止までのデフォルトの日数',
