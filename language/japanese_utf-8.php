...
$LANG_PDF = array(
    1 => 'PDF生成ができません。',
    2 => 'ドキュメントは変換されませんでした。受け取ったドキュメントを処理されていません。XHTML標準によって書かれたHTML形式のドキュメントであることを確認してください。複雑すぎるHTMLのドキュメントは正しく変換されなかったり，まったく変換されない場合があります。ドキュメントの変換結果は0バイトのサイズの場合は削除されています。ドキュメントが変換可能だと確信できる場合は，もう一度実行してみてください。',
