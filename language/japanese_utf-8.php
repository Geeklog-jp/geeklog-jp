...
$LANG08 = array(
    ...
    39 => 'あなたはメッセージを ',
    40 => " 秒前に送信しています。このサイトでは，少なくとも{$_CONF['speedlimit']}秒待って、次のメッセージを送信してください。"
);
...
$LANG32 = array(
    ...
    66 => 'ファイルアップロードは PHP コンフィギュレーション設定により，無効になりました。',
...
$LANG_confignames['Core'] = array(
    ...
    'ip_lookup' => 'IP検索',
    'url_rewrite' => 'URLリライト',
    'cdn_hosted' => 'CDN-hosted copy of jQueryを使う',
    'meta_tags' => 'メタタグ',
...
$LANG_tab['Core'] = array(
    ...
    'tab_imagelib' => 'Imageライブラリ',
    'tab_upload' => 'アップロード',
    'tab_articleimg' => '記事内の画像',
...
$LANG_VALIDATION = array(
    ...
    0 => 'から',
    1 => 'このフィールドは特定の範囲内の値を入れなければなりません',
    ...
    'single_char' => 'このフィールドには半角１文字を入力してください'
);
