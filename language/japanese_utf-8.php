...
$LANG04 = array(
    ...
    55 => 'すべてのチェックをはずした場合は、デフォルトを選択したことになります。ひとつでもチェックすると、このデフォルトの選択は関係なくなりますので、読みたいものを全部チェックするようにしてください。 デフォルトの話題は強調表示しています。',
    56 => '投稿者名',
    57 => '表示モード',
    58 => '並べ替えの順序',
    59 => 'コメントの最大数',
    ...
    112 => 'ログインの試行回数を超えてしまいました。後ほどまたログインしてみてください。',
    113 => 'ログインできませんでした',
    114 => 'アカウントが無効になっています',
...
$LANG24 = array(
    ...
    21 => 'トラックバック・ピングを送る',
    22 => '記事の一覧',
    23 => '記事の編集・削除は編集アイコンを、記事の閲覧は記事のタイトルを、記事の作成は上の「新規作成」をクリックしてください。',
    ...
    49 => '右',
    50 => '左',
    51 => '<p>記事に添付した画像は、自動タグで記述してください。書式は、[imageX]、[imageX_right]、[imageX_left](Xは添付した画像の番号)(例 [image1])。注意: 添付した画像は記事内ですべて使用しなければ記事を保存できません。<br' . XHTML . '><strong>プレビュー</strong>: 画像付きの記事はドラフト(下書き)として保存して閲覧してください。プレビューボタンは画像が無いときにのみ利用できます。</p>',
    52 => '',
...
$LANG27 = array(
    ...
    7 => '話題IDと話題名を入力してください',
    8 => '話題の管理',
    9 => '話題とは、記事カテゴリのことです。話題の編集・削除は各話題名を、新しい話題の作成は「新規作成」のリンクをクリックしてください。括弧内は、あなたのアクセスレベルです。アスタリスク(*)の付いた話題は、記事投稿時のデフォルトです。',
    10 => '順序',
    11 => '1ページあたりの記事数',
    12 => 'アクセスを拒否しました',
    ...
    34 => '子の話題を継承',
    35 => '表示しない',
    36 => '話題を継承するだけで、表示しないで直接閲覧できないようにします。',
    37 => 'ルート',
    38 => 'すべて',
    39 => 'ホームページのみ',
    40 => 'ひとつ以上の話題を割り当ててください。',
    41 => '"すべて" を選ぶと、そのアイテムはすべての話題に表示します。"ホームページのみ"を選ぶと、ホームページだけに表示します。それ以外の場合は少なくともひとつ以上の話題を選択してください。 ',
    42 => '継承の欄は割り当てた話題のリストを含んでいます。話題を選択すると、その話題の親の話題が継承します。継承の欄に表示するには、先にアイテムを保存しなければなりません。',
...
$LANG28 = array(
    ...
    'autotag_desc_user' => '[user: id alternate title] - ユーザー名をタイトルとしてユーザーへのリンクを表示します。別のタイトルを指定できますが、必須ではありません。'
);
...
$LANG32 = array(
    ...
    11 => 'プラグインを編集や削除するには、プラグインの編集アイコンをクリックしてください。すると、プラグイン作者のウェブサイトを含んだ詳細を表示します。インストールしているバージョンとプラグインのコードから得られたバージョンの両方を表示します。これはプラグインのアップグレードが必要かどうかを知るのに役立ちます。プラグインのインストールやアップグレードについては、そのドキュメントをご覧ください。',
...
$MESSAGE = array(
    ...
    15 => 'あなたのコメントは審査のために受け付けてました。管理者の承認後に公開します。。',
    16 => 'あなたは登録を解除しました。今後、新たな通知を受けることはできません。',
    17 => '',
    18 => '',
    19 => '',
    20 => '',
    ...
    82 => 'ログインの試行回数を超えてしまいました。後ほどまたログインしてみてください。',
    ...
    91 => '無効な識別のURLを指定しました。',
    92 => "使用する前に<a href=\"{$_CONF['site_admin_url']}/sectest.php\">ウェブサイトのセキュリティチェックを行ってください</a>!",
...
$LANG_ACCESS = array(
    ...
    'permmsg' => '注意: メンバーとはすべてのログインしているサイトのメンバーで、ゲストユーザーはログインせずに閲覧しているすべての閲覧者です。',
    ...
    'cancel' => 'キャンセル',
    'delete' => '削除',
    'canteditroot' => 'Rootグループに所属していないのにRootグループを編集しようとしたため、アクセスを拒否しました。これがエラーだと思う場合はシステムの管理者に連絡してください。',
    ...
    'cantlistgroup' => 'メンバーリストを閲覧するためには、グループのメンバーでなければなりません。これがエラーだと思う場合はシステムの管理者に連絡してください。',
...
$LANG_TRB = array(
    ...
    'resend' => '再送信',
    'ping_all_explain' => 'あなたがリンクしたことを相手のサイトに知らせたり(<a href="http://en.wikipedia.org/wiki/Pingback">ピングバック</a>)、ウェブログディレクトリサービスにピングを送ってサイトの更新を知らせたり、誰かのサイトの記事について書いたときに<a href="http://ja.wikipedia.org/wiki/%E3%83%88%E3%83%A9%E3%83%83%E3%82%AF%E3%83%90%E3%83%83%E3%82%AF">トラックバック</a>を送ったり、といったことをできます。',
    ...
    'no_services' => 'ウェブログディレクトリサービスを設定していません。',
    'services_headline' => 'トラックバック管理',
    'service_explain' => 'ピング送信先のウェブログディレクトリサービスの編集や削除をするには下の編集アイコンをクリックしてください。新しいウェブログディレクトリサービスを追加する場合は「新規作成」をクリックしてください。',
    'service' => 'サービス',
    'ping_method' => 'ピングメソッド',
...
$LANG_confignames['Core'] = array(
    ...
    'path_themes' => 'テーマのパス',
    'disable_new_user_registration' => '新規ユーザー登録を停止',
    'allow_user_themes' => 'テーマ選択を許可',
    'allow_user_language' => '言語選択を許可',
    'allow_user_photo' => '写真登録を許可',
    'allow_username_change' => 'ユーザー名変更を許可',
    'allow_account_delete' => 'アカウント削除を許可',
    'hide_author_exclusion' => '所有者を表示できなくする許可',
    'show_fullname' => 'ユーザー名の代わりに氏名を表示',
    'show_servicename' => 'サービス名を表示',
    'custom_registration' => 'カスタム登録を有効',
    'user_login_method' => 'ログイン方法',
    'facebook_login' => 'FacebookのOAuthを有効',
    'facebook_consumer_key' => 'Facebook OAuth Application ID',
    'facebook_consumer_secret' => 'Facebook OAuth Application Secret',
    'linkedin_login' => ' LinkedInのOAuthを有効',
    'linkedin_consumer_key' => 'LinkedIn OAuth API Key',
    'linkedin_consumer_secret' => 'LinkedIn OAuth Secret Key',
    'twitter_login' => 'TwitterのOAuthを有効',
    ...
    'lastlogin' => '最終のログインを記録',
    'num_search_results' => '検索結果表示件数のデフォルト',
    'loginrequired' => 'すべてにログインを必要',
    'submitloginrequired' => '投稿にログインを必要',
    'commentsloginrequired' => 'コメント投稿にログインを必要',
    'statsloginrequired' => '統計の参照にログインを必要',
    'searchloginrequired' => '検索にログインを必要',
    'profileloginrequired' => 'プロフィール閲覧にログインを必要',
    'emailuserloginrequired' => 'メールの送信にログインを必要',
    'emailstoryloginrequired' => '記事のメール送信にログインを必要',
    'directoryloginrequired' => '記事の一覧表示にログインを必要',
    'storysubmission' => '記事の投稿を審査',
    'usersubmission' => 'ユーザーの登録を審査',
    'listdraftstories' => 'ドラフトの記事を一覧に表示',
    'notification' => '通知',
    'postmode' => '投稿モードのデフォルト',
    'speedlimit' => '投稿間隔の制限',
    'skip_preview' => 'プレビューなしで投稿',
    'advanced_editor' => 'アドバンストエディターの使用',
    'wikitext_editor' => 'Wikiテキストエディターの使用',
    'cron_schedule_interval' => 'Cronのスケジュール間隔',
    'sortmethod' => '記事の並べ替え',
    'showstorycount' => '記事数の表示',
    'showsubmissioncount' => '記事の投稿数を表示',
    'hide_home_link' => 'Homeへのリンクを表示しない',
    'whosonline_threshold' => 'セッションの閾値',
    'whosonline_anonymous' => 'ゲストユーザーに表示しない',
    'whosonline_photo' => 'サムネイルの写真の表示',
    'emailstories' => 'デイリーダイジェストの送信',
    'emailstorieslength' => '記事の長さ',
    'emailstoriesperdefault' => '新しく登録したユーザーにデフォルトで有効',
    ...
    'hidenewplugins' => 'プラグインの新着項目の表示をしない',
    ...
    'pingback_self' => '自身へピングバック',
    'pingback_excerpt' => 'ピングバックを要約',
    'link_documentation' => 'ドキュメントのリンクを表示',
    'link_versionchecker' => 'バージョンチェッカーのリンクを表示',
    'maximagesperarticle' => '記事に配置する画像の最大数',
    'limitnews' => '1ページの記事の表示数',
    'minnews' => '最小の記事の表示数',
    'contributedbyline' => '所有者を表示',
    'hideviewscount' => '閲覧数を表示しない',
    'hideemailicon' => 'メールアイコンを表示しない',
    'hideprintericon' => '印刷アイコンを表示しない',
    'allow_page_breaks' => '改ページの許可',
    'page_break_comments' => '改ページ時のコメント表示位置',
    'article_image_align' => '話題アイコンの表示位置',
    'show_topic_icon' => '話題アイコンをデフォルトで表示',
    'draft_flag' => 'ドラフトモードをデフォルト',
    'frontpage' => 'トップページ配置をデフォルト',
    'hide_no_news_msg' => '記事がない場合のメッセージを表示しない',
    'hide_main_page_navigation' => 'ページナビゲーションを表示しない',
    'onlyrootfeatures' => 'Rootユーザーだけに注目記事の設定を許可',
    'aftersave_story' => '記事保存後の画面',
    'aftersave_user' => 'ユーザー保存後の画面',
    'show_right_blocks' => '右ブロックを常に表示',
    ...
    'debug_image_upload' => '画像のアップロードをデバッグ',
    'keep_unscaled_image' => '元の画像を保持',
    'allow_user_scaling' => 'ユーザーに画像のサイズ変更を許可',
    ...
    'disable_autolinks' => '自動タグを無効',
    'clickable_links' => 'URLを自動リンク',
    'linktext_maxlen' => 'クリッカブルリンクの長さ',
    'compressed_output' => 'HTMLの出力を圧縮して送信',
    ...
    'disable_webservices' => 'ウェブサービスを無効',
    'restrict_webservices' => 'ウェブサービスを制限',
    ...
    'allow_reply_notifications' => '返信のメール通知を許可',
    'comment_on_same_page' => 'コンテンツと同じページでコメントを投稿',
    ...
    'disable_breadcrumbs_topics' => '話題のパンくずリストを無効',
    'disable_breadcrumbs_articles' => '記事のパンくずリストを無効。',
    'disable_breadcrumbs_plugins' => 'プラグインのパンくずリストを無効',
    'breadcrumb_root_site_name' => 'サイト名をパンくずリストのルートに設定'
);
