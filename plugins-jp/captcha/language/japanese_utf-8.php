...
$LANG_CP00 = array (
    ...
    'installed'         => 'CAPTCHAプラグインをインストールしてあります。',
    'uninstalled'       => 'CAPTCHAプラグインをインストールしてありません。',
    'install_success'   => 'CAPTCHAプラグインをインストールしました。<br /><br /><a href="%s">管理画面</a>をご覧ください。',
    'install_failed'    => 'インストールできませんでした。 -- エラーログをご覧ください。',
