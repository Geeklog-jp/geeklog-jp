...
$_CONF_VALIDATE['captcha']['gfxDriver'] = array(
    'rule' => array('inList', array('0', '1', '2'), true)
);
$_CONF_VALIDATE['captcha']['gfxFormat'] = array(
    'rule' => array('inList', array('jpg', 'png'), true)
);
$_CONF_VALIDATE['captcha']['imageset'] = array(
    'rule' => array('inList', array('default', 'simple'), true)
);
