...
# japanese_utf-8.php
#
# This is the Japanese UTF-8 language file for the Geeklog Calendarjp plugin
#
...
$LANG_CALJP_1 = array(
    ...
    25 => '-',
    26 => 'イベントを投稿する',
    27 => "{$_CONF['site_name']}にイベントを投稿すると、サイト全体のカレンダーに登録されます。<br" . XHTML . ">全体カレンダーのイベントは、各ユーザーが必要に応じて個人カレンダーに登録できます。",
    28 => 'タイトル',
    29 => '終了時間',
    30 => '開始時間',
    31 => '終日',
...
###############################################################################
# admin/plugins/calendarjp/index.php, formerly admin/event.php ($LANG22)

$LANG_CALJP_ADMIN = array(
    1 => 'イベントの編集',
    2 => 'エラー',
    3 => '投稿モード',
    4 => 'URL',
    ...
    11 => 'カレンダー管理',
    12 => 'イベントの編集・削除は、下のイベントの編集アイコンをクリックしてください。新しいイベントを作る場合、上の「新規作成」をクリックしてください。コピーを作る場合は既存イベントのコピーアイコンをクリックしてください。',
    13 => '投稿者',
    14 => '開始日',
    15 => '終了日',
    16 => '',
    17 => "管理権限のないイベントを編集しようとしました。この行為は記録されました。<a href=\"{$_CONF['site_admin_url']}/plugins/calendarjp/index.php\">イベント編集画面</a>に戻ってください。",
    18 => '',
    19 => '',
    20 => '保存',
    21 => 'キャンセル',
...
$LANG_CALJP_MESSAGE = array(
    'save'      => 'イベントが保存されました。',
    'delete'    => 'イベントが削除されました。',
    'private'   => 'イベントが個人カレンダーに保存されました。',
    'login'     => '個人カレンダーを開くには、最初にログインしてください。',
    'removed'   => '個人カレンダーからイベントが削除されました。',
    'noprivate' => 'このサイトでは、個人カレンダーが無効です。',
    'unauth'    => 'イベント管理ページにアクセスする権限がありません。このアクセスは記録させていただきましたのでご了承ください。',
);

$PLG_calendarjp_MESSAGE4  = "{$_CONF['site_name']}にイベントを投稿していただき、ありがとうございます。スタッフに送信され、承認待ちの状態になりました。承認された場合、このサイトの<a href=\"{$_CONF['site_url']}/calendarjp/index.php\">カレンダー</a>セクションに表示されます。";
$PLG_calendarjp_MESSAGE17 = 'イベントが保存されました。';
$PLG_calendarjp_MESSAGE18 = 'イベントが削除されました。';
$PLG_calendarjp_MESSAGE24 = 'イベントが個人カレンダーに保存されました。';
$PLG_calendarjp_MESSAGE26 = 'イベントが削除されました。';

// Messages for the plugin upgrade
$PLG_calendarjp_MESSAGE3001 = 'プラグインのアップグレードはサポートされていません。';
$PLG_calendarjp_MESSAGE3002 = $LANG32[9];

// Localization of the Admin Configuration UI
$LANG_configsections['calendarjp'] = array(
    'label' => 'カレンダーjp',
    'title' => 'カレンダーjpの設定'
);
...
$LANG_confignames['calendarjp'] = array(
    ...
    'advanced_editor' => 'アドバンストエディターを使う',
    'wikitext_editor' => 'Wikiテキストエディターを使う',
...
$LANG_configselects['calendarjp'] = array(
    ...
    6 => array('12' => 12, '24' => 24),
    9 => array('作成したイベントを表示する' => 'item', 'カレンダー管理を表示する' => 'list', 'カレンダーを表示する' => 'plugin', 'ホームを表示する' => 'home', '管理画面トップを表示する' => 'admin'),
