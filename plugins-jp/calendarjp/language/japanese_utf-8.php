...
$LANG_CALJP_ADMIN = array(
    ...
    15 => '終了日',
    16 => '',
    17 => "管理権限のないイベントを編集しようとしました。このアクセスを記録しました。<a href=\"{$_CONF['site_admin_url']}/plugins/calendarjp/index.php\">イベント編集画面</a>に戻ってください。",
    18 => '',
    19 => '',
    20 => '保存',
    21 => 'キャンセル',
...
$LANG_CALJP_MESSAGE = array(
    ...
    'unauth'    => 'イベント管理ページにアクセスする権限がありません。権限のない機能へのアクセスはすべて記録しています。',
);

$PLG_calendarjp_MESSAGE4  = "{$_CONF['site_name']}にイベントを投稿していただき、ありがとうございます。スタッフによる承認待ちの状態となりました。承認が済むと、このサイトの<a href=\"{$_CONF['site_url']}/calendarjp/index.php\">カレンダー</a>セクションにイベントを表示します。";
$PLG_calendarjp_MESSAGE17 = 'イベントを保存しました。';
$PLG_calendarjp_MESSAGE18 = 'イベントを削除しました。';
$PLG_calendarjp_MESSAGE24 = 'イベントを個人カレンダーに保存しました。';
$PLG_calendarjp_MESSAGE26 = 'イベントを削除しました。';

// Messages for the plugin upgrade
$PLG_calendarjp_MESSAGE3001 = 'プラグインのアップグレードはサポートしていません。';
