...
$PLG_calendarjp_MESSAGE4  = "{$_CONF['site_name']}にイベントを投稿していただき、ありがとうございます。スタッフに送信され、承認待ちの状態になりました。承認された場合、このサイトの<a href=\"{$_CONF['site_url']}/calendarjp/index.php\">カレンダ</a>セクションに表示されます。";
$PLG_calendarjp_MESSAGE17 = 'イベントが保存されました。';
$PLG_calendarjp_MESSAGE18 = 'イベントが削除されました。';
$PLG_calendarjp_MESSAGE24 = 'イベントが個人カレンダに保存されました。';
...
$LANG_fs['calendarjp'] = array(
    ...
    'fs_permissions' => 'カレンダjpのデフォルトパーミッション（[0]所有者 [1]グループ [2]メンバー [3]ゲスト）'
);
