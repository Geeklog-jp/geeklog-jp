...
// (18) 初期ブロックタイトル等日本語化
$_SQL[] = "UPDATE {$_TABLES['blocks']} "
		. "SET title = 'User Functions' "
		. "WHERE (name = 'user_block') ";

$_SQL[] = "UPDATE {$_TABLES['blocks']} "
		. "SET title = 'Admins Only' "
