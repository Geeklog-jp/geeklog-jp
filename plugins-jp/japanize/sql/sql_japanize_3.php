...
$_SQL[] = "DELETE FROM {$_TABLES['pingservice']} "
		. "WHERE (site_url = 'http://www.blogpeople.net/') ";

$_SQL[] = "INSERT INTO {$_TABLES['pingservice']} "
...
$_SQL[] = "DELETE FROM {$_TABLES['pingservice']} "
		. "WHERE (site_url = 'http://ping.bloggers.jp/') ";
...
//@@@@@20080903 ウェブサイト変更
$_SQL[] = "DELETE FROM {$_TABLES['pingservice']} "
		. "WHERE (site_url = 'http://www.myblog.jp/') ";

$_SQL[] = "DELETE FROM {$_TABLES['pingservice']} "
		. "WHERE (site_url = 'http://rss.drecom.jp/') ";
...
//http://blog.goo.ne.jp/
$_SQL[] = "DELETE FROM {$_TABLES['pingservice']} "
		. "WHERE (site_url = 'http://blog.goo.ne.jp/') ";
...
//3.ピング送信先に Googleブログ検索追加
//Googleブログ検索 拡張ピング
$_SQL[] = "DELETE FROM {$_TABLES['pingservice']} "
		. "WHERE (site_url = 'http://blogsearch.google.co.jp/') ";
