...
$_SQL[] = "UPDATE {$_TABLES['groups']} "
		. "SET grp_descr = 'サイト管理者' "
		. "WHERE (grp_name = 'Root') ";

$_SQL[] = "UPDATE {$_TABLES['groups']} "
		. "SET grp_descr = 'すべてのユーザー' "
...
$_SQL[] = "UPDATE {$_TABLES['groups']} "
		. "SET grp_descr = '話題譲渡管理者' "
		. "WHERE (grp_name = 'nmoxtopicown Admin') ";

$_SQL[] = "UPDATE {$_TABLES['groups']} "
		. "SET grp_descr = 'サイトマップ管理者' "
...
$_SQL[] = "UPDATE {$_TABLES['groups']} "
		. "SET grp_descr = 'テーマエディタ管理者' "
		. "WHERE (grp_name = 'themedit Admin') ";

# $_SQL[] = "UPDATE {$_TABLES['groups']} "
# 		. "SET grp_descr = 'GoogleMaps管理者' "
