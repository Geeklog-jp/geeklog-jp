...
$LANG_MYCALJP = array (
    ...
    'admin'             => 'サイトカレンダー Mycaljp の管理',
    'install_header'    => 'サイトカレンダー Mycaljp プラグインのインストール/アンインストール',
    'installed'         => 'サイトカレンダー Mycaljp プラグインはインストールされています。',
    'uninstalled'       => 'サイトカレンダー Mycaljp プラグインはインストールされていません。',
    'install_success'   => 'サイトカレンダー Mycaljp プラグインのインストールに成功しました。',
    'install_failed'    => 'サイトカレンダー Mycaljp プラグインのインストールに失敗しました。詳細はエラーログ(error.log)をご覧ください。',
    'uninstall_msg'     => 'サイトカレンダー Mycaljp プラグインはアンインストールされました。',
    'install'           => 'インストール',
    'uninstall'         => 'アンインストール',
    'warning'           => '警告！　サイトカレンダー Mycaljp プラグインは有効なままです。',
    'enabled'           => 'アンインストールする前に，サイトカレンダー Mycaljp プラグインを無効にしてください。',
