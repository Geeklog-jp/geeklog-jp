...
$LANG_CMED = array(
    ...
    'installed'           => 'カスタムメニュープラグインをインストールしてあります。',
    'uninstalled'         => 'カスタムメニュープラグインをインストールしてありません。',
    'install_success'     => 'カスタムメニュープラグインをインストールしました。',
    'install_failed'      => 'カスタムメニュープラグインのインストーできませんでした。詳細はエラーログ(error.log)をご覧ください。',
    'uninstall_msg'       => 'カスタムメニュープラグインをアンインストールしました。',
    'install'             => 'インストール',
    'uninstall'           => 'アンインストール',
