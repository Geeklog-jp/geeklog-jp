...
'option_no'						=> 'いいえ',
'lang_japanese'					=>'日本語',
'lang_english'					=>'English（英語）',
'lang_spanish'					=>'Español(スペイン語)',
'lang_bulgarian'				=>'Български（ブルガリア語）',
'lang_hebrew'					=>'עברית（ヘブライ語）',
'lang_slovenian'				=>'Slovenščina（スロヴェニア語）',
'lang_romanian'					=>'Română（ルーマニア語）',
'lang_chinese_simplified'			=>'中文（中国語 簡体字）',
'lang_croatian'					=>'Hrvatski（クロアチア語）',
'lang_french_canada'				=>'Français Canada（カナダ語）',
'lang_catalan'					=>'Català（カタルーニャ語）',
'lang_bosnian'					=>'Bosanski（ボスニア語）',
'lang_danish'					=>'Dansk（デンマーク語）',
'lang_french_france'				=>'Français（フランス語）',
'lang_german_formal'				=>'Deutsch formal(ドイツ語)',
'lang_slovak'					=>'Slovenčina（スロヴァキア語）',
'lang_czech'					=>'Česky（チェコ語）',
'lang_turkish'					=>'Türkçe（トルコ語）',
'lang_portuguese_brazil'			=>'Portuguese Brazil（ポルトガル語）',
'lang_dutch'					=>'Nederlands（オランダ語）',
'lang_italian'					=>'Italiano（イタリア語）',
'lang_indonesian'				=>'Bahasa Indonesia（インドネシア語）',
'lang_portuguese'				=>'Português（ポルトガル語）',
'lang_polish'					=>'Polski（ポーランド語）',
'lang_finnish'					=>'Suomi（フィンランド語）',
'lang_korean'					=>'한국어（韓国語/朝鮮語）',
'lang_afrikaans'				=>'Afrikaans（アフリカーンス語）',
'lang_swedish'					=>'Svenska（スウェーデン語）',
'lang_russian'					=>'Русский（ロシア語）',
'lang_farsi'					=>'فارسی（ペルシア語）',
'lang_norwegian'				=>'Nynorsk（ノルウェー語）',
'lang_chinese_traditional'			=>'中文（中国語 繁体字）',
'lang_spanish_argentina'			=>'Español Argentina（スペイン語）',
'lang_hellenic'					=>'Ελληνικά（ギリシャ語）',
'lang_german'					=>'Deutsch（ドイツ語）',
'lang_ukrainian'				=>'Українська（ウクライナ語）'
);
