...
// Geeklog Japanese Ivy added by suggestion from obache
if ( empty( $_USER['uid'] ) OR $_USER['uid'] == 1 )
       SendError( 1, 'This connector require login' ) ;

// Geeklog Japanese Tsuchi added 2007/04/04
if (!SEC_hasRights('story.edit'))
       SendError( 1, 'Only Story Admin can access this connector.' ) ;
