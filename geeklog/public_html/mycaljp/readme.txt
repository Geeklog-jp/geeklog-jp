...
Step 3)
ご使用中のテーマのfunctions.phpをテキストエディタで開き、適当な行に次の文字列、
...
Ver.1.0.7 (2007.11.6) スライドカレンダーの表示に対応.
Ver.1.0.8 (2007.11.19) 従来型サイトカレンダーのカスタマイズ用テンプレートファイルが
　　　　　　　　　　　 同梱されていないミスの修正.
