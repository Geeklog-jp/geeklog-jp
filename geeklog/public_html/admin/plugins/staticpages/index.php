...
//@@@@@20060907 update writtenby sort true(liststaticpages)
//@@@@@20060907 update header sort default title -> date(liststaticpages)
//@@@@@20070225 add $template_path = staticpages_templatePath (); (form)
...
function form ($A, $error = false)
{
    ...
    $template_path = staticpages_templatePath (); //@@@@@20070225add
...
//@@@@@20060907 update ----->
                    ...
                    array('text' => $LANG_STATIC['writtenby'], 'field' => 'sp_uid', 'sort' => true),//@@@@@20060907 update <-----
