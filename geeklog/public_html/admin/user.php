...
function batchdelete()
{
    ...
    $text_arr['form_start'] = "<form action=\"{$text_arr['form_url']}\" method=\"post\" id=\"admin-list\" class=\"basic\">";
    $text_arr['form_end'] = "<input type=\"hidden\" name=\"mode\" value=\"batchdeleteexec\">".LB."</form>";
    // } 投稿管理で承認/削除の問題。ブロック管理の先頭の有効/無効の問題 対応 2007/05/01 hiro
    $display .= ADMIN_list ("user", "ADMIN_getListField_users", $header_arr, $text_arr,
