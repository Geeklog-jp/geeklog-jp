...
//@@@@@ 20051026,20070102 kaigyo sisugiru (COM_Mail)
//@@@@@ 20070118 mojibake (COM_rdfImport)
//@@@@@ 20070115 for mobile (COM_refresh)
//@@@@@ 20070118 multilingual support (COM_getLangSQL)
//@@@@@ 20070301 $subject = COM_emailEscape( $subject ) (COM_Mail)
//@@@@@ 20070312 $from = COM_formatEmailAddress(～
//@@@@@ 20071012 (COM_emailUserTopics)
//@@@@@ 20071025 modified COM_formatEmailAddress, COM_emailEscape, and COM_mail
//               to use 'custom_mail_20071025.php'.
...
function COM_rdfImport( $bid, $rdfurl, $maxheadlines = 0 )
{
    ...
    $feed = $factory->reader( $rdfurl, $charset );
    ...
    if( $feed )
    {
        ...
        for( $i = 0; $i < $readmax; $i++ )
        {
            ...
            //if ( (PHP_VERSION >= 5) and ($charset == 'utf-8')) {
            //    $title = $feed->articles[$i]['title'];
            //} else {
                $title = mb_convert_encoding(
                    $feed->articles[$i]['title'], $charset,
                    mb_detect_encoding( $feed->articles[$i]['title'],
                    "UTF-8,EUC-JP,JIS,SJIS" ) ); 
            //}
            //@@@@@update 20070118 <-----
...
function COM_emailUserTopics()
{
    ...
    $subject = strip_tags( strftime($LANG08[30], time() ) );
    //@@@@@20071012update<----
    ...
    for( $x = 1; $x <= $nrows; $x++ )
    {
        ...
        $mailtext = strip_tags( strftime($LANG08[29], time()  ))  . "\n";
        //@@@@@20071012update<----
