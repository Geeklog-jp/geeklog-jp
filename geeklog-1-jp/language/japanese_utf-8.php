...
$LANG21 = array(
    ...
    23 => '順序',
    24 => '',
    25 => 'ブロックの編集・削除はブロックの編集アイコンをクリック、ブロックの作成は上の「新規作成」をクリックしてください',
    26 => 'レイアウト用ブロック',
    27 => 'PHPブロック',
    28 => 'PHPブロックのオプション',
    29 => '関数',
...
$LANG24 = array(
    ...
    21 => 'トラックバック・ピングを送る',
    22 => '記事管理',
    23 => '記事の編集は記事の編集アイコンをクリック、記事の閲覧は記事のタイトルをクリック、記事の作成は上の「新規作成」をクリックしてください。',
...
$LANG28 = array(
    ...
    11 => 'ユーザ管理',
    12 => 'ユーザの編集は編集アイコンをクリック、ユーザの作成は「新規作成」をクリック、ユーザの一括登録（インポート）は「一括登録」をクリック、ユーザの一括削除は「一括削除」をクリックしてください。',
    13 => 'セキュリティ',
    14 => '登録日',
    15 => '',
    16 => '',
...
$LANG32 = array(
    ...
    11 => 'プラグインの編集は編集アイコンをクリックしてください。プラグイン作者のページリンクも表示されます。プラグインのバージョンは、インストール中のものとファイルから得られたものが表示されます。これによってプラグインの更新の必要性を判断することができます。',
...
$LANG33 = array(
    ...
    11 => '新しいフィード',
    12 => '管理画面',
    13 => 'フィードの編集は，編集アイコンをクリックしてください。フィードの作成は上の「新規作成」をクリックしてください。',
    14 => 'タイトル',
    15 => 'タイプ',
    16 => 'ファイル名',
    17 => 'フォーマット',
...
$LANG_ACCESS = array(
    ...
    'groupmanager' => 'グループ管理',
    'newgroupmsg' => 'グループの編集は編集アイコンをクリック、グループ作成は上の「新規作成」をクリックしてください。ただし、「コア（中核）グループ」はシステムで使用するため削除できません。',
    'groupname' => 'グループ名',
    'coregroup' => 'コアグループ',
    'yes' => 'はい',
    'no' => 'いいえ',
...
$LANG_TRB = array(
    ...
    'service_explain' => 'ピング送信先のウェブログディレクトリサービスの編集は編集アイコンをクリック、ウェブログディレクトリサービスを作成する場合は「新規作成」をクリックしてください。',
    'service' => 'サービス',
    'ping_method' => 'ピングメソッド',
...
$LANG_SECTEST = array(
    ...
    10 => ' ディレクトリを削除してください。',
    11 => 'このディレクトリを残しておくと、悪意のあるユーザがサイトを破壊したり、乗っ取ったり、重要な情報を入手したりする可能性があります。',
    12 => 'OK!  admin/installディレクトリは削除されているようです。',
    13 => 'Rootユーザのパスワード（',
    14 => '人分）が<strong>インストール時の初期値</strong>("password")から変更されていません。',
    ...
    19 => 'ドキュメントの',
    20 => 'インストール方法',
    21 => 'を読み直し、インストールを先に進める前に設定を変更してください。',
    22 => 'ログのディレクトリ（非公開領域/logs）',
    23 => 'プラグインのディレクトリ（非公開領域/plugins）',
    24 => 'システムディレクトリ（非公開領域/system）',
    25 => 'バックアップディレクトリ（非公開領域/backups）',
    26 => 'バックアップディレクトリに一時ファイルを作成できませんでした。このディレクトリのパーミッションを確認してください。',
    27 => 'データディレクトリ（非公開領域/data）',
    28 => 'データディレクトリに一時ファイルを作成できませんでした。このディレクトリのパーミッションを確認してください。',
    29 => 'すべて問題なさそうです。',
    30 => 'サイトを使用する前に、上記の問題点を修正してください。',
    31 => 'どのようなサイトでも100%安全ということはありません。このスクリプトで検査できるのは、主要なセキュリティ上の問題点だけです。',
    32 => 'Geeklogの新規リリースとセキュリティ上の問題点について情報を得るには、',
    33 => ' メーリングリスト（送られてくるメールは極めて少ない）を購読し、かつ、ときどき管理者専用メニューから ',
    34 => ' を行って、Geeklogの更新版が出ていないか確認することをお勧めします。',
);
...
$LANG_configselects['Core'] = array(
    ...
    9 => array('作成した記事を表示する' => 'item', '項目一覧を表示する' => 'list', 'サイトのトップページを表示する' => 'home', '管理画面TOPを表示する' => 'admin'),
